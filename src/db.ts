...
export function createTable(tableName: string, columnStructure: Object) {
...
export function getAllFromDatabase(query: string) {
...
export function runstmt(query: string) {
    return new Promise((resolve, reject) => {
        db.run(
            query,
            (error) => {
